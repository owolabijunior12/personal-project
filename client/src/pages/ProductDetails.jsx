...
const ProductDetails = () => {
  ...
  return (
    <div className='w-full'>
      <Header/>
      {productData[0].map(({product_model_number,product_serial_number, product_color,brand, description ,product_image,product_name,product_size,product_price,product_quantity,product_status,product_type,product_weight})=>
      <div  className='flex flex-col mt-28 w-full justify-center items-center'>
        <div className=' w-350 pb-2'>              
                <img src={product_image} alt="" className=' w-full rounded-lg ' />              
        </div>
        ...
        <div  className='relative flex  min-w-160 p-6   cursor-pointer text-textColor   bg-primary m-4  shadow-md rounded-lg flex-col'>
            ...
            <h1 className='flex justify-start text-4xl mr-52 text-textColor font-extrabold mb-4'>{product_name}</h1>
            <p className='text-2xl mb-2'>${product_price} <span className=' text-red-500 text-xs'>save up 20%</span></p>
            <p className='text-2xl mb-2'>
              {product_color.map((product_color)=>
              <p>{product_color},</p>
              )}              
            </p>
            <p className='text-2xl mb-2'>{product_weight}</p>
            <p className='text-2xl mb-2'>{product_quantity}</p>
            ...
            <p className='flex mr-5'> <div className='bg-green-600 rounded-full mt-1 w-0 h-0 p-2 m-2 '></div> <p>Status: {product_status} </p></p>
            <div className=' mb-4'>
              <AiOutlineHeart/>
        ...
        <div className='mb-4'>
          ...
          <tbody className=' my-4 '>
            ...
            <td className='border p-4'> {product_name} </td>    
            <tr>
              <th className='border p-4' >Name:</th>
            ...
            <tr>
               ...
               <td className='border p-4'>{product_serial_number}</td> 
              </tr>   
            <tr>
               <th className='border p-4' >Model-Number:</th>
               <td className='border p-4'> {product_model_number} </td> 
              </tr>   
            <tr>
               <th className='border p-4' >Size:</th>
               <td className='border p-4'> {product_size} </td> 
              </tr>   
            <tr>
               <th className='border p-4' >New / Used:</th>
               <td className='border p-4'> {product_type} </td> 
              </tr>   
        ...
        <div className='mb-4'>
            ...
            <p>
              <p className='text-2xl font-bold'> Fast Delivery:</p>
                ...
                <span className='text font-semibold text-lg'>Used product </span> will take 1-2 working days to be delievered Lorem ipsum dolor sit amet consectetur
                 adipisicing elit. Nobis quibusdam et, quia, eius atque, dolorum voluptas repellendus quod necessitatibus
                  cumque nisi iure provident mollitia rerum impedit magnam maiores. Eveniet, pariatur corrupti,
                   sapiente sequi repellendus quia impedit minus debitis veritatis ad earum deleniti ex quidem dicta in
                    magni fuga cumque tenetur maxime possimus repellat error officiis? Blanditiis atque consequuntur
