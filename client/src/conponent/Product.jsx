...
const Product = () => {
  return (
    ...
    {[
         ...
         <div className="relative flex w-40 min-w-210 px-2 py-4 cursor-pointer hover:shadow-xl  hover:bg-green-400 bg-black m-4 shadow-md rounded-lg flex-col items-center">
